...
export type AUTH_HEADERS_REQUEST_SUCCEEDED = "redux-token-auth/AUTH_HEADERS_REQUEST_SUCCEEDED";
export const AUTH_HEADERS_REQUEST_SUCCEEDED: AUTH_HEADERS_REQUEST_SUCCEEDED =
  "redux-token-auth/AUTH_HEADERS_REQUEST_SUCCEEDED";
...
export interface AuthHeadersSucceededAction {
  readonly type: AUTH_HEADERS_REQUEST_SUCCEEDED;
  readonly payload: {
